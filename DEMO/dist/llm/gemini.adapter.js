...
exports.createGeminiCaller = createGeminiCaller;
...
function getModel() {
    ...
    if (!apiKey || apiKey === 'your_gemini_api_key_here') {
        throw new Error('[KHantix/Gemini] GEMINI_API_KEY is not set. ' +
...
if (require.main === module) {
    (async () => {
        ...
        try {
            const result = await callGemini('Return valid JSON with a single field: {"status": "gemini_ok"}');
